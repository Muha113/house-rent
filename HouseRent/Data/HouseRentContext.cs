...
namespace HouseRent.Models
{
    public class HouseRentContext : DbContext
    {
        ...
        public DbSet<HouseRent.Models.RentRange> RentRage { get; set; }
        ...
        public DbSet<HouseRent.Models.AdvertiseRequest> AdvertiseRequest { get; set; }
        
        public DbSet<HouseRent.Models.Compliment> Compliment { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RentRange>().Property(x => x.Status).HasColumnType("tinyint");
        }
    }
}
